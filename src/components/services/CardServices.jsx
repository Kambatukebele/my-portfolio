...
const CardServices = ({ id, icon, title, description }) => {
  return (
    <div className="w-full flex flex-col justify-start items-start gap-4 shadow-md py-4 px-4 rounded-2xl bg-purple900 h-[300px] cursor-pointer duration-200 ease-in-out hover:bg-blue">
